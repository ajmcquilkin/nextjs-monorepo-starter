...
export const createPost = (
  fields: Pick<Post,
    'type' | 'requestedPublicationDate' | 'submitterNetId' | 'fromName' | 'fromAddress' | 'eventDate' | 'eventTime'
    | 'fullContent' | 'briefContent' | 'url' | 'recipientGroups' | 'featuredImage' | 'featuredImageAlt' | 'status'
  >,
